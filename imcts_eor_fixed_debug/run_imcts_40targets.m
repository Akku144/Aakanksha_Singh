...
cfg.Dvmax = 5.000;                        % 500 m/s = 0.5 km/s
cfg.cp = sqrt(2);
cfg.NmaxPhase = 1;                        % paper does not state Nmax for IMCTS case
cfg.verbose = true;
tic;
%[result, root] =  imcts_allocate_ultrafast(ssc, targets(1:cfg.Nt,:), cfg, P);
